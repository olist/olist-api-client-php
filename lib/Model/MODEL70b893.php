 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MODEL70b893 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MODEL70b893';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['terms_of_use_version'] === null) {
            $invalid_properties[] = "'terms_of_use_version' can't be null";
        }
        if ($this->container['seller'] === null) {
            $invalid_properties[] = "'seller' can't be null";
        }
