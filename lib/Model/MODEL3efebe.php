 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MODEL3efebe implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MODEL3efebe';
    ...
    protected static $attributeMap = [
        'about' => 'about',
        'account_executive_id' => 'account_executive_id',
    ...
    protected static $setters = [
        'about' => 'setAbout',
        'account_executive_id' => 'setAccountExecutiveId',
    ...
    protected static $getters = [
        'about' => 'getAbout',
        'account_executive_id' => 'getAccountExecutiveId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['account_executive_id'] = isset($data['account_executive_id']) ? $data['account_executive_id'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['address_city'] === null) {
            $invalid_properties[] = "'address_city' can't be null";
        }
        if ($this->container['address_number'] === null) {
            $invalid_properties[] = "'address_number' can't be null";
        }
        if ($this->container['address_postal_code'] === null) {
            $invalid_properties[] = "'address_postal_code' can't be null";
        }
        if ($this->container['address_state'] === null) {
            $invalid_properties[] = "'address_state' can't be null";
        }
        if ($this->container['address_street'] === null) {
            $invalid_properties[] = "'address_street' can't be null";
        }
        ...
        if ($this->container['crt'] === null) {
            $invalid_properties[] = "'crt' can't be null";
        }
        if ($this->container['email'] === null) {
            $invalid_properties[] = "'email' can't be null";
        }
        if ($this->container['ie'] === null) {
            $invalid_properties[] = "'ie' can't be null";
        }
    ...
    /**
     * Gets account_executive_id
     * @return string
     */
    public function getAccountExecutiveId()
    {
        return $this->container['account_executive_id'];
    }

    /**
     * Sets account_executive_id
     * @param string $account_executive_id 
     * @return $this
     */
    public function setAccountExecutiveId($account_executive_id)
    {
        $this->container['account_executive_id'] = $account_executive_id;
