 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MODEL686451 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MODEL686451';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['features'] === null) {
            $invalid_properties[] = "'features' can't be null";
        }
        ...
        if ($this->container['picture_url'] === null) {
            $invalid_properties[] = "'picture_url' can't be null";
        }
        if ($this->container['treatment'] === null) {
            $invalid_properties[] = "'treatment' can't be null";
        }
